...
// ═══════════════════════════════════════════════════════
//  Pixel_Polis Tiles — ERC-721 NFT land ownership
...
contract Pixel_PolisTiles is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory svg = string(abi.encodePacked(
            ...
            '<text x="175" y="200" text-anchor="middle" fill="#c9d8f0" font-size="22" font-family="monospace">PIXEL_POLIS TILE</text>',
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            '{"name":"Pixel_Polis Tile [', Strings.toString(x), ',', Strings.toString(z), ']",',
            '"description":"A land tile in Pixel_Polis — the on-chain city builder.",',
